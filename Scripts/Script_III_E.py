#Ce script reprends les principales étapes de notre notebook sur la dernière sous-partie de la partie modélisation (prédiction de l'activité)
...
y = np.array(EEC_2019_subsample["ACTIF"])
...
y_total = np.array(EEC_2019["ACTIF"])
...
disp.plot()
plt.savefig("Scripts/Results/Actif/Confusion_Matrix_2019.png")
...
disp.plot()
plt.savefig("Scripts/Results/Actif/Confusion_Matrix_2020_fit_2019")